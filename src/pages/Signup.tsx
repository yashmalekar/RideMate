...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if(!/[A-Z]/.test(password) || !/\d/.test(password) || !/[a-z]/.test(password) || !/[!@#$%^&*(),.?":{}|<>]/.test(password)){
      toast({
        title: 'Password should contain atleast 1 Uppercase, 1 Lowercase, 1 Number and 1 Special Character',
        variant: 'destructive',
      })
      return;
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="relative z-10 w-full max-w-md p-8 glass-card animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold gradient-text">Join RideMate</h1>
